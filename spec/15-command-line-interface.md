...
```bash
orbit complex_program.ob --dump-ir=debug.ir --print-stacks-on-call=main --profile
```

Combine multiple debugging and analysis options for comprehensive program analysis.
