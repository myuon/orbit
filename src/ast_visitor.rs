...
// Walk functions
pub fn walk_expr<V: Visitor + ?Sized>(visitor: &mut V, expr: &mut PositionedExpr) {
...
pub fn walk_stmt<V: Visitor + ?Sized>(visitor: &mut V, stmt: &mut PositionedStmt) {
...
pub fn walk_decl<V: Visitor + ?Sized>(visitor: &mut V, decl: &mut PositionedDecl) {
...
pub fn walk_program<V: Visitor + ?Sized>(visitor: &mut V, program: &mut Program) {
    for decl in &mut program.declarations {
        visitor.visit_decl(decl);
    }
}

pub fn walk_function<V: Visitor + ?Sized>(visitor: &mut V, func: &mut PositionedFunction) {
...
pub fn walk_struct_decl<V: Visitor + ?Sized>(visitor: &mut V, struct_decl: &mut PositionedStructDecl) {
...
pub fn walk_global_variable<V: Visitor + ?Sized>(visitor: &mut V, global_var: &mut PositionedGlobalVariable) {
